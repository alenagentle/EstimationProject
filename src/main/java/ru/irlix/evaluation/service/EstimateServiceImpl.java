...
public class EstimateServiceImpl implements EstimateService{
    ...
    public void saveEstimate(EstimateDTO estimateDTO) {
        ...
        for (PhaseDTO phaseDTO: phasesDTO) {
            System.out.println("phaseDTO.getName() = " + phaseDTO.getName());
            System.out.println("phaseDTO.getManagementReserve() = " + phaseDTO.getManagementReserve());
        }
    ...
    public void savePhases(List<Phase> phases) {
        ...
        {
            System.out.println("phase.getName() = " + phase.getName());
            System.out.println("phase.getManagementReserve() = " + phase.getManagementReserve());
            savePhase(phase);
        }
            }
